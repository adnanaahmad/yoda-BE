...
START="service-admin.js service-certs.js service-mfa.js service-plaid-ach.js service-synthetic-id.js service-veriff.js handler-email.js handler-twilio.js handler-webhook.js helper-forwarder.js helper-shortener.js helper-uploader.js"
